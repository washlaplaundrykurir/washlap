...
import { BarChart3, ClipboardList, Truck, CheckCircle2, ScrollText, Users, User, LayoutDashboard, LogOut, FileSpreadsheet } from "lucide-react";
import React from "react";

export const adminLinks = [
    { href: "/admin", label: "Dashboard", icon: <LayoutDashboard size={20} /> },
    { href: "/admin/orders", label: "Belum Ditugaskan", icon: <ClipboardList size={20} /> },
    { href: "/admin/tugas", label: "Tugas Kurir", icon: <Truck size={20} /> },
    { href: "/admin/selesai", label: "Selesai", icon: <CheckCircle2 size={20} /> },
    { href: "/admin/riwayat", label: "Riwayat", icon: <ScrollText size={20} /> },
    { href: "/admin/users", label: "Users", icon: <Users size={20} />, superAdminOnly: true },
    { href: "/admin/customers", label: "Pelanggan", icon: <User size={20} /> },
    { href: "/admin/reports", label: "Laporan", icon: <FileSpreadsheet size={20} />, superAdminOnly: true },
];

export const kurirLinks = [
    { href: "/kurir", label: "Dashboard", icon: <LayoutDashboard size={20} /> },
    { href: "/kurir/tasks", label: "Tugas Saya", icon: <ClipboardList size={20} /> },
    { href: "/kurir/history", label: "Riwayat", icon: <ScrollText size={20} /> },
];

export function DashboardNavbar({ role: initialRole, hideDesktopNav = false }: DashboardNavbarProps) {
    const router = useRouter();
    const pathname = usePathname();
    const [userRole, setUserRole] = useState<"super-admin" | "admin" | "kurir">(initialRole);
