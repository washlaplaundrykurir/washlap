...
export default function CustomersPage() {
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      showToast(
        "error",
        err instanceof Error ? err.message : "Error updating customer",
      );
    } finally {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      showToast(
        "error",
        err instanceof Error ? err.message : "Error deleting customer",
      );
    } finally {
      setActionLoading(false);
    }
          ...
          <ModalBody>
            <div className="flex flex-col gap-4">
              ...
              <Input
                ...
                onValueChange={(v) =>
                  setFormData({ ...formData, nama_terakhir: v })
                }
              />
              <Textarea
                label="Alamat"
                ...
                onValueChange={(v) =>
                  setFormData({ ...formData, alamat_terakhir: v })
                }
              />
              <Input
                ...
                onValueChange={(v) =>
                  setFormData({ ...formData, google_maps_terakhir: v })
                }
              />
            </div>
          </ModalBody>
        ...
        <ModalContent className="bg-white dark:bg-gray-900">
          ...
          <ModalBody>
            <p className="text-gray-600 dark:text-white/70">
              ...
              <strong>
                {selectedCustomer?.nama_terakhir || selectedCustomer?.nomor_hp}
              </strong>
              ?
            </p>
          </ModalBody>
