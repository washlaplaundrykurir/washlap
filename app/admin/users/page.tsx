...
export default function UsersPage() {
    ...
    const handleCreate = async () => {
        try {
            ...
            showToast("error", err instanceof Error ? err.message : "Error creating user");
        } finally {
    ...
    const handleUpdate = async () => {
        ...
        try {
            ...
            showToast("error", err instanceof Error ? err.message : "Error updating user");
        } finally {
            setActionLoading(false);
        }
    };
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            showToast("error", err instanceof Error ? err.message : "Error deleting user");
        } finally {
            setActionLoading(false);
        }
    };
        ...
        <>
                                        ...
                                        users.map((user) => (
                                            ...
                                            >
                                                ...
                                                <td className="py-3 px-4">
                                                    <Chip size="sm" color={roleColor(user.role)} variant="flat">
            ...
            <Modal isOpen={createModal.isOpen} onClose={createModal.onClose}>
                <ModalContent className="bg-white dark:bg-gray-900">
                    ...
                    <ModalFooter>
                        ...
                        <Button color="primary" isLoading={actionLoading} onClick={handleCreate}>
                            Simpan
                        </Button>
                    </ModalFooter>
                </ModalContent>
            ...
            <Modal isOpen={editModal.isOpen} onClose={editModal.onClose}>
                <ModalContent className="bg-white dark:bg-gray-900">
                    ...
                    <ModalBody>
                        <div className="flex flex-col gap-4">
                            <Input label="Email" value={formData.email} isDisabled />
                            <Input
                                label="Nama Lengkap"
                                value={formData.full_name}
                                onValueChange={(v) => setFormData({ ...formData, full_name: v })}
