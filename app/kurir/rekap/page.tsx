...
import { ArrowLeft, FileChartColumn } from "lucide-react";
    ...
    <div className="max-w-4xl mx-auto p-4 md:p-6">
      ...
      {error && (
        <Card className="bg-red-500/20 border border-red-500/30 mb-6">
          <CardBody className="text-red-600 p-4 text-center">{error}</CardBody>
        </Card>
      )}
      ...
      {isLoading ? (
        ...
        <div className="overflow-x-auto">
          <Table
            aria-label="Tabel Rekapitulasi"
            classNames={{
              wrapper:
                "backdrop-blur-xl bg-white/60 dark:bg-white/15 border border-black/10 dark:border-white/30 shadow-none",
            }}
          >
            <TableHeader>
